...
/**
 * write_num - write a number that is using a bufffer
 * @ind: Index of which the number starts on the buffer
 * @buffer: buffer
 * @flags: flags
 * @width: width
 ...
 * @extra_c: extra chars
 *
 * Return: amount of the printed chars.
 */
 ...
 * @is_negative:numbers that is indicating if the num is negative
 * @ind: Index of which the number starts in the buffer
 ...
 * @size: sizes specifier
 *
 * Return: amount of written the chars.
 */
 ...
 * @padd: char that is representing the padding
 * @extra_c: char that is representing extra char
 * @padd_start: Index of which padding should start
 *
 * Return: amount of the written chars.
 */
